...
const int pitchPin5 = A5;
const int pitchPin6 = A6;
...
void updateControl()
{
  ...
  int pot_value5 = mozziAnalogRead(pitchPin5);
  sineOsc5.setFreq(pot_value5);
  int pot_value6 = mozziAnalogRead(pitchPin6);
  sineOsc6.setFreq(pot_value6);
